// Password Protection System for YallaStarter - MOBILE OPTIMIZED VERSION
// Password: Yalla**2025
...
(function() {
    ...
    // Create password modal with mobile-optimized design
    function createPasswordModal() {
        ...
        // Create modal box with responsive sizing
        ...
        title.style.fontSize = isMobileDevice ? '20px' : '24px';
        
        // Create subtitle with responsive font size
        ...
        subtitle.style.fontSize = isMobileDevice ? '14px' : '16px';
        ...
        // Create password input with mobile optimization
        ...
        if (isMobileDevice) {
            ...
            passwordInput.style.fontSize = '16px'; // Prevents zoom on iOS
            passwordInput.style.minHeight = '44px'; // Touch-friendly minimum
        } else {
        ...
        // Create submit button with mobile optimization
        ...
        if (isMobileDevice) {
            ...
            submitBtn.style.minHeight = '44px'; // Touch-friendly minimum
        } else {
        ...
        // Create error message with responsive sizing
        ...
        errorDiv.style.fontSize = isMobileDevice ? '13px' : '14px';
        errorDiv.style.lineHeight = '1.3';
        
        // Create attempts info with responsive sizing
        ...
        attemptsDiv.style.fontSize = isMobileDevice ? '12px' : '14px';
        attemptsDiv.style.lineHeight = '1.3';
